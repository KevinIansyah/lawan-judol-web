                ...
                <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                    <div className="flex-1 flex-col justify-center rounded-br-lg rounded-bl-lg p-6 leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:flex lg:rounded-tl-lg lg:rounded-br-none lg:px-15 dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                        ...
                        <p className="text-muted-foreground mb-2 text-sm">
                            Judi online bukan sekadar permainan, ini ancaman bagi masa depan kita.
                            Mari bersatu menciptakan ruang digital yang sehat. Gunakan platform kami
                            untuk
                            <strong>
                                {' '}
                                mendeteksi dan menghapus komentar-komentar judi online
                            </strong>{' '}
                            secara otomatis dari video YouTube Anda.
                        </p>
                        ...
                        <Button asChild>
                            <Link href={auth.user ? '/analysis/your-video' : '/login'}>
                    ...
                    <div className="relative h-full w-full rounded-t-lg bg-red-50 lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-red-700/10">
                        <img
                            ...
                            alt="Logo"
                            className="object-cover transition-all duration-750 starting:translate-y-6 starting:opacity-0"
                        />
