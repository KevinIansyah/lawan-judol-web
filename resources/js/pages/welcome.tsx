            ...
            <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                    <div className="flex-1 flex-col justify-center rounded-br-lg rounded-bl-lg p-6 leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:flex lg:rounded-tl-lg lg:rounded-br-none lg:px-15 dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                        ...
                        <ul className="mb-4 flex flex-col text-sm font-medium lg:mb-6">
                            <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                ...
                                <span>
                                    ...
                                    <br />
                                    <a href="https://laravel.com/docs" target="_blank" className="ml-1 inline-flex items-center space-x-1 font-medium text-[#DC2626] underline underline-offset-4 dark:text-[#FF4433]">
                            ...
                            <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                ...
                                <span>
                                    ...
                                    <br />
                                    <a href="https://laracasts.com" target="_blank" className="ml-1 inline-flex items-center space-x-1 font-medium text-[#DC2626] underline underline-offset-4 dark:text-[#FF4433]">
                        ...
                        <Button asChild>
                            <Link href={auth.user ? '/analysis/your-video' : '/login'}>Analisis Video Sekarang!</Link>
                        </Button>
                    </div>
