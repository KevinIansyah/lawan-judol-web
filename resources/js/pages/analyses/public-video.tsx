    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col rounded-xl px-4 py-6">
                <Heading title="Analisis Video Publik" description="Lihat riwayat analisis video dan mulai analisis baru kapan saja." />
                <DataTableAnalysis data={data} pageIndex={pageIndex} setPageIndex={setPageIndex} totalPages={last_page} totalItems={total} perPage={per_page} />
            </div>
        </AppLayout>
    );
}
