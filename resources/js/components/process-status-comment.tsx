...
interface ProcessStatusCommentProps {
    finished: boolean;
    successCount: number;
    errorCount: number;
...
export const ProcessStatusComment = ({ finished, successCount, errorCount, selectedCount, processLogs }: ProcessStatusCommentProps) => {
    return (
